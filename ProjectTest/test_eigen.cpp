...
static void test0()
{
	...
	std::array<Vector3d, 3> trigon = { Vector3d(-10, 0), Vector3d(70, 0), Vector3d(50, 50) };
	...
	std::array<Vector3d, 3> trigonA = { Vector3d(-10, -10), Vector3d(10, -10), Vector3d(0, 10) };
...
/*	cout << mat << endl;
	...
	Eigen::Vector3d b2 = b1.hnormalized(); //尾部单位化，尾部数字会除以前面的数字，以实现单位化
