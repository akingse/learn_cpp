...
static void _test1()
{
	...
	double angle1 = eigen::get_angle_of_two_vectors(vecA, vecB);
	double angle2 = eigen::get_angle_of_two_unit(vecA, vecB);
...
static void _test2()
{
	...
	angle1 = eigen::get_angle_of_two_vectors(vecA, vecB);
	angle2 = eigen::get_angle_of_two_unit(vecA, vecB);
	d = angle1 - angle2;
