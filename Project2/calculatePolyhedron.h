...
namespace psykronix
{
	...
	DLLEXPORT Eigen::Vector3d getInterpenetrationDistanceOfTwoMeshs(const std::vector<Eigen::Vector3d>& vboA, const std::vector<std::array<int, 3>>& iboA, const std::vector<Eigen::Vector3d>& vboB, const std::vector<std::array<int, 3>>& iboB);
	// clash detection
